...
@endif
        ...
        <div class="flex flex-col sm:flex-row gap-3">
            <a href="{{ route('orders.show', $order->id) }}"
               class="flex-1 flex items-center justify-center gap-2 border border-gray-200 text-gray-700 hover:border-blue-300 hover:text-blue-600 font-semibold py-3.5 rounded-xl transition text-sm">
            ...
            <a href="{{ route('products.index') }}"
               class="flex-1 flex items-center justify-center gap-2 bg-blue-600 hover:bg-blue-700 text-white font-semibold py-3.5 rounded-xl transition text-sm shadow-md shadow-blue-100">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
